...
// ============================================================
//  EXPANDED ROAST POOLS — 35-38 ADDITIONS PER POOL PER PERSONA
// ============================================================

const openingsAdd = {
  staff_engineer: [
    "I've analyzed your credentials, and I've seen bootloader logs with more emotional maturity and direction than this.",
    "Let me guess: you think 'clean code' is when you delete all comments so nobody can prove you don't know how it works.",
    "Your project list reads like a series of cry-for-help messages wrapped in Markdown headers.",
    "You are a glorified copy-paste tourist who has never once had to live with the consequences of their architectural decisions.",
    "This resume has the structural stability of a Jello skyscraper built on a fault line of deprecated npm modules.",
    "I have reviewed your skills section, and my professional estimation of your productivity is functionally zero.",
    "You talk about microservices like you're an engineering leader, but the only thing you lead is the build warning count.",
    "Your contribution graph is green because you commit README typos, not because you write working software.",
    "As a Staff Engineer, looking at this makes me want to delete my own git history in protest.",
    "You claim 'mentorship' on this resume. Who did you mentor? The junior devs you forced to clean up your merge conflicts?",
    "If your coding speed is as slow as your learning curve, it's a miracle you've ever finished a sprint.",
    "You listed 15 tools but your repos contain zero code test cases. You're not an engineer, you're an enthusiast.",
    "This resume is a masterpiece of keyword stuffing designed to fool ATS algorithms and disappoint actual humans.",
    "You write code like a junior developer who just discovered Stack Overflow and lacks all self-restraint.",
    "I've seen shell scripts written by sleep-deprived interns that had more design foresight than your entire portfolio.",
    "You are a compiler's worst nightmare: confident, reckless, and typing without thinking.",
    "If this resume was a pull request, I would close it without comment and block your branch.",
    "Your resume claims design ownership, but your repositories show standard, unmodified tutorial boilerplates.",
    "You write code like you're paid by the line and evaluated by the number of bugs you introduce.",
    "The ambition-to-output ratio here is high enough to destabilize a production database cluster.",
    "You list Rust because it's trendy, but your actual repositories are pure, unoptimized Node.js chaos.",
    "Your commits are mostly 'fix' and 'update'. Collaborative git history is completely absent.",
    "Your primary contribution to the codebase is increasing the bundle size and the coffee budget.",
    "If this is your best work, I dread to see the code you actually hide behind private repository blocks.",
    "You describe your work with words like 'revolutionized'—meaning you changed a button padding by 2px.",
    "This profile suggests a developer who spent more time on LinkedIn than inside an actual IDE.",
    "I've met spreadsheet macros with more software engineering discipline than what is shown here.",
    "You claim to solve complex problems, yet your featured projects section lists a basic calculator app.",
    "Your code organization has the structural integrity of wet cardboard.",
    "You listed Docker because you ran a container once and it didn't immediately crash your laptop.",
    "You're a script monkey calling yourself a systems engineer. Reconsider the title.",
    "The gap between what you think you know and what you can prove is wider than a junior's margin of error.",
    "Every line in this document screams 'I watch 10-minute crash courses and call it production experience'.",
    "I respect the hustle, but I cannot respect the evidence. There isn't any.",
    "You list 'optimization enthusiast'—meaning you spent four hours refactoring a function that runs once a year."
  ],
  faang_gatekeeper: [
    "Your resume passed our automated keywords scanner and disappointed our human reviewers simultaneously.",
    "You listed expertise in technologies whose documentation you clearly never finished reading.",
    "Fifteen frameworks on a resume with zero system design context is a Wikipedia reading list, not a stack.",
    "You have confused watching a conference talk about distributed systems with actually building one.",
    "Listing LeetCode on a resume is bold. Listing LeetCode without mentioning a single solved problem is art.",
    "Your skills section is sized for a principal engineer and backed by evidence for a bootcamp graduate.",
    "Every senior interviewer who sees this document will ask the same question: 'Did anyone review this?'",
    ...
    "I could teach you more in one whiteboard session than your project history suggests you have learned in two years.",
    "This document wants FAANG compensation for tutorial-tier evidence. The math does not work.",
    "Your system design section will collapse under a single question about data consistency.",
    "You list Kubernetes but your longest deployment was a Vercel preview page. Calm down.",
    "I've screened thousands of candidates. Yours is the exact blueprint of a copy-paste developer.",
    "You write code in a sandbox and think you're ready for FAANG scale. You're not.",
    "The confidence displayed here is a compelling argument for mandatory reality checks before submission.",
    "You are a candidate who will perform well in a sandbox and freeze when production crashes.",
    "Your project details are vague in exactly the way that suggests you did not own the work.",
    "You listed 'expert' for technologies you've only used in school or tutorial projects.",
    "The signal-to-noise ratio in this document is aggressively negative.",
    "Passed on. The skills section is impressive. The evidence for any of it is not present.",
    "You list 'distributed databases' but probably don't know the difference between SQL and NoSQL trade-offs.",
    "No hire. Reapply when you have a production incident story. Any story at all.",
    "Your resume is technically correct in the same way that 'I touched a piano once' is music experience.",
    "You have selected comfort over competence at every fork in your learning path.",
    "A dependency tree with 847 packages tells me you have outsourced every hard problem to someone else.",
    "You have optimized your resume for keyword matching and not for the technical conversation it will initiate.",
    "Your self-assessment operates significantly above the level supported by your evidence.",
    "The person this resume presents would be outperformed by any candidate with two years of real experience.",
    "You have studied the form of strong candidates without the substance that makes them strong.",
    "Confidence in an interview is not a substitute for depth, and depth is what is being tested.",
    "You are a good candidate for a role two levels below what you are applying for.",
    "The preparation you have done is real. The experience it is masking the absence of is also real.",
  ...
  devops_veteran: [
    "I've survived seventeen production outages. Your resume has survived exactly zero, and it shows.",
    "Docker in the skills section. Zero pipeline configuration anywhere. I know this pattern too well.",
    "I can spot a developer who has never had a Friday deploy go wrong within three lines. You are that developer.",
    "The infrastructure section of your resume is a wish list, not a track record.",
    "You type 'scalability' with the hands of someone whose apps have never met a real user.",
    "Reading this resume required me to take a beta blocker. Please ship something before submitting this again.",
    "Your resume describes DevOps with zero evidence of ops. The 'Dev' part is also questionable.",
    ...
    "The pipeline section of this resume is empty because you have never written one that went to actual production.",
    "Docker on the skills list. Zero mention of image layers, build caching, multi-stage builds, or production considerations.",
    "I have maintained infrastructure that serves millions of requests. Your infrastructure serves a demo that broke last Tuesday.",
    "Monitoring appears nowhere in this document. You have never been responsible for knowing when something broke.",
    "Zero on-call experience means zero understanding of what happens when your code meets reality at 2am.",
    "The confidence to list Kubernetes without mentioning pod autoscaling, resource limits, or namespace isolation is a remarkable act of self-belief.",
    "Your 'cloud experience' is a serverless function on a free tier that has never received more than twelve requests.",
    ...
    "No mention of secrets management, environment segregation, or deployment rollback strategies. These are not advanced topics.",
    "You have listed infrastructure tools the way a tourist lists cities they have flown over.",
    "An SRE who has never written a runbook or conducted a post-mortem is a developer with a job title upgrade.",
    "Your infrastructure is stateless in the sense that it does not retain any evidence of having been real.",
    "Database backups, disaster recovery, and failover strategies are conspicuously absent from your DevOps experience.",
    "The difference between your claims and your evidence is measurable in production hours you have not logged.",
    "You talk about infrastructure with the vocabulary of someone who has read the documentation and the confidence of someone who has survived the alerts.",
  ...
  rust_elitist: [
    ...
    "The abstractions you use are designed to make the hard problems invisible. They are still there.",
    "Your build times are slow because you do not understand what the build is actually doing.",
    "Every tool in your stack has been chosen for developer experience. None of them have been designed for runtime predictability.",
    "You have chosen the most forgiving environments available and called it software engineering.",
    "Your instinct, when facing a bug, is to search Stack Overflow for the error message rather than reason about the cause.",
    "You have never been forced by a compiler to understand why your code is wrong. That is a privilege with a cost.",
    "The abstractions you use daily are built on top of problems you have never been required to solve.",
...
const evidencesAdd = {
  staff_engineer: [
    ...
    "Code quality cannot be assessed because none of the linked repositories have been maintained past the initial commit.",
    "Your experience section describes the work of a junior developer using the vocabulary of a senior engineer.",
    "Your code formatting is pristine, which is nice because it distracts from the absolute lack of architectural depth.",
    "You claim to design systems but your commits are all on the frontend. The backend is a standard Firebase collection.",
    "The test suite runs in 2 seconds because it contains three test cases. Test coverage is a cosmetic parameter.",
    "You list 'design patterns'—meaning you learned what a singleton is and proceeded to use it everywhere.",
    "There is no evidence that you have ever refactored code written by someone else. You only write greenfield toys.",
    "Your pull requests are merged without discussion because your team consists of you and your imaginary advisor.",
    "The documentation describes how to run the project. It fails to mention why the server crashes under any load.",
    "You use CSS keyframe animations to hide the fact that your page load latency is 4.2 seconds.",
    "Your database schema has zero indexes. Every query triggers a full table scan. This is a crime.",
    "You describe yourself as a 'problem solver'—meaning you spend three hours on Stack Overflow for every line of code.",
    "The project history shows no signs of collaboration. No issues, no pull requests from others, no code review.",
    "You listed TypeScript because you write standard JS and cast everything as 'any'. We see you.",
    "The commit messages are an emotional diary. 'please work', 'fixed bug', 'hopefully final'. That is not collaboration.",
    "You claim 'mentorship' but your repositories show you coding alone in the dark since 2024.",
    "You describe your stack as 'modern'—meaning you change frameworks every three months to avoid writing real logic.",
    "Every project linked is a single-developer repository with zero active users. This is an archive, not a portfolio.",
    "You claim database expertise but you have never run an EXPLAIN query in your entire professional life.",
    "The resume includes 'agile methodology' because you used a Trello board for your personal todo list.",
    "Your API endpoints are completely unversioned and lack any validation. A single invalid character crashes the node process.",
    "You list 'clean architecture'—meaning you created 14 directories for a project that has 200 lines of code.",
    "Your dependency graph contains left-pad. The security audit is a tragedy of warnings."
  ],
  faang_gatekeeper: [
    "Every technology listed here was added after watching a conference talk, not after debugging a production incident.",
    "The absence of performance metrics is telling. Real systems have latency numbers. Tutorial projects have completion dates.",
    ...
    "The confidence in this resume is something I respect as a human quality and fear as an engineering manager.",
    "Framework knowledge is not engineering. The interview will ask you to reason from first principles and your resume has none.",
    "Your algorithmic skills are memorized patterns from LeetCode. If the problem deviates from the catalog, you will fail.",
    "You list 'RESTful APIs' but your endpoints return 200 OK for every single error case.",
    "The resume lacks any mention of technical trade-offs. You describe your choices as if there were only one right answer.",
    "Your database knowledge is limited to basic CRUD. You have never sharded, replicated, or indexed a database under load.",
    "The project section includes three different clones of popular SaaS sites. Originality is statistically zero.",
    "You claim to understand caching but your project is just using Redis with default configuration and zero cache invalidation strategies.",
    "Listing 'machine learning' because you called the OpenAI SDK. The interview will ask you about linear algebra.",
    "The experience section reads like a summary of the syllabus of the courses you completed.",
    "You describe 'high-performance' systems but the project has never been accessed by more than five people.",
    "Your code is heavily coupled and lacks any unit test coverage. This will not survive the system design round.",
    "You list 'concurrency' but your project runs in a single-threaded runtime with no lock contention analysis.",
    "The resume contains zero quantification of outcomes. Did the performance improve? By how much? We don't know.",
    "You list 'cloud native' because you deployed a static frontend to Netlify. That is not cloud native.",
    "The system diagram described is a copy of a standard architectural blog post. It doesn't reflect your code.",
    "You claim to be an expert in React but cannot explain the reconciliation algorithm or fiber architecture.",
    "The projects are all single-file scripts disguised as modular systems.",
    "Your contribution history is a series of green dots that represent code formatters, not engineering output.",
    "You listed Web3 because you watched a smart contract crash course. You have zero deployed code on testnets.",
    "The interview will ask you to optimize a slow SQL query. Your resume suggests you will suggest rewriting it in NoSQL.",
    "You claim 'clean code' but your codebase is a nested array of ternary operators and magic numbers."
  ],
  devops_veteran: [
    "The pipeline section of this resume is empty because you have never written one that went to actual production.",
    "Docker on the skills list. Zero mention of image layers, build caching, multi-stage builds, or production considerations.",
    ...
    "The difference between your claims and your evidence is measurable in production hours you have not logged.",
    "Your deployment strategy appears to consist of running npm start and hoping the environment variable is correct.",
    "You listed AWS but your IAM policy is a single root user with full administrator permissions. This is a security hazard.",
    "Your CI/CD pipeline is a manual git push origin master. There are no build checks.",
    "You claim infrastructure-as-code experience but you have never written a Terraform state file in your life.",
    "The deployment logs are full of build errors that you bypassed by turning off the linter checks in CI.",
    "You listed 'high availability' but your setup is a single ec2 instance with no backup or auto-scaling configuration.",
    "Your secret management strategy is committing the .env file directly to your public GitHub repository.",
    "You claim to be an SRE but you cannot explain the difference between a health check and a readiness probe.",
    "Your logging strategy is console.log statements scattered across the codebase with no centralized telemetry.",
    "The monitoring setup is you refreshing the page periodically to check if the site is still up.",
    "You listed Nginx because you copy-pasted a reverse proxy config from a Medium article and never touched it again.",
    "The resume describes 'automated scaling'—meaning you manually spin up another server when the site gets slow.",
    "Your database backups are stored in the same directory as the database file on the same disk. Good luck.",
    "You claim Docker expertise but your images are 1.2 GB because you don't know how to use multi-stage builds.",
    "The pipeline doesn't have any error handling. If a build fails, the deploy script just leaves the site broken.",
    "You list 'cloud security' but the security group has port 22 open to the entire internet.",
    "The production cluster is actually a single node running on a free tier instance with zero redundancy.",
    "Your on-call runbook is a text document that says 'restart the server and pray'. That is not SRE.",
    "You describe 'highly secure infrastructure' but your database has no password and is exposed publicly.",
    "You listed Helm but you have never customized a chart. You just run helm install and hope for the best.",
    "The deployment takes 15 minutes because you are downloading the entire node_modules directory on every build."
  ],
  oss_maintainer: [
    "The commit messages in your repository read like internal monologue rather than communicative engineering history.",
    "Zero open issues, zero closed issues, zero contributors beyond yourself. This is not a project. It is a folder.",
    ...
    "A repository with star count zero and fork count zero has never been evaluated by anyone who did not already know you.",
    "Your repositories have not been touched in months and contain no documentation that would allow another human to use them.",
    "You claim open-source contributions but your only PR was fixing a spelling mistake in a library README.",
    "The repository has 42 stars because you asked all your classmates to star it on the first day of class.",
    "You list 'collaborative development' but the git commit history has only one author: you.",
    "The code quality checker returned 18 warnings that you ignored by adding eslint-disable comments to every file.",
    "Your issue tracker is empty because nobody else is using the software you spent three months writing.",
    "You describe your project as an 'ecosystem'—meaning it has a frontend, a backend, and a README.",
    "The commit history shows you haven't touched this project since the day you put it on your resume.",
    "You claim to write maintainable code but the codebase is a single 4000-line index.js file.",
    "Your dependency list includes 45 helper libraries for problems that could be solved in three lines of vanilla JS.",
    "The documentation has a 'getting started' section that fails at step 2 due to outdated dependency versions.",
    "You listed your portfolio as an open-source project. It's just a static HTML file that you hosting on github.",
    "Your pull requests contain messages like 'fixed stuff' and 'clean code'. No description of changes or why they were made.",
    "You have never had a pull request rejected. That means you have never submitted code to a real project.",
    "The codebase is full of commented-out code blocks from previous tutorials you copied it from.",
    "You list 'API designer' but your endpoints are inconsistent, return arbitrary shapes, and have zero validation.",
    "Your code formatting is completely inconsistent because you don't use Prettier or ESLint rules.",
    "The build is broken on master. This tells me everything about your development workflow.",
    "You listed your fork as an original project. Changing the name in the package.json does not make it yours.",
    "Your test suite consists of a single test that prints 'all tests passed' to the console automatically.",
    "The commit graph has a huge gap between semesters. You only code when you're being graded."
  ],
  exhausted_recruiter: [
    "The objective statement at the top of this resume describes what you want, not what you offer. We are interested in the latter.",
    "Every bullet point in this resume ends with a generality. Not one ends with a number, a metric, or a measurable outcome.",
    ...
    "Three companies in eighteen months is not 'diverse experience'. It is a pattern that hiring managers notice.",
    "Your experience section describes the same role at three companies with different names and identical bullet points.",
    "The bullet points are so generic they could apply to any job in the world, including coffee shop cashier.",
    "You list 'experience with agile methodologies'—meaning you sat in standup meetings and said 'no blockers'.",
    "Your skills list is so long it takes up half the page. We both know you don't know half of these tools.",
    "The only number on your resume is your phone number. Hiring managers want metrics, not just text.",
    "You describe yourself as a 'thought leader' on a resume that has one year of junior development experience.",
    "The internship bullet points are written in the passive voice. 'Assisted with research' is code for 'ordered lunch'.",
    "Your resume is two pages long but contains only one page of actual content. The spacing is doing heavy lifting.",
    "You listed your college group project as professional work. We can tell from the repository name.",
    "The summary section contains seven adjectives in the first sentence. None of them are backed by evidence.",
    "You claim to have 'led development' on a project where you were the only developer. That is not leadership.",
    "The job titles on your resume are inconsistent with your actual experience level. You're cosplaying seniority.",
    "Your contact info is missing a link to your portfolio. If we can't see the code, we assume it's bad.",
    "You listed 'quick learner' because you don't have enough projects to prove you actually know the tools.",
    "The company descriptions are longer than your achievements at those companies. You're advertising them, not yourself.",
    ...
    "Your project section lists a weather app that uses a hardcoded API key and has been broken for six months.",
    "You describe yourself as 'passionate' but your github graph has been grey since the boot camp ended.",
    "The experience section starts with your education. This tells us your career hasn't started yet.",
    "Your bullet points describe what the team did, not what you did. You're taking credit for others' work."
  ],
  rust_elitist: [
    "The frameworks you rely on exist to protect you from understanding what your code is actually doing.",
    "You have never written code where getting the ownership model wrong would prevent compilation. That is a significant knowledge gap.",
    ...
    "Every tool in your stack has been chosen for developer experience. None of them have been designed for runtime predictability.",
    "Your entire project history runs in environments where memory management is handled by a garbage collector that hides your mistakes.",
    "You listed JavaScript as a systems language. This is a category error of monumental proportions.",
    "Your understanding of garbage collection is 'it deletes variables when I'm done'. That is not systems thinking.",
    ...
    "You listed Rust because you read a blog post about it. Your actual repository has three commits of a hello-world template.",
    "The database you use has no transactions and no schema validation. Data integrity is just a concept to you.",
    "You claim to optimize for memory but your web app loads 14MB of javascript on the initial page render.",
    "You have never written a lock, a mutex, or a semaphore. Concurrency is just a keyword to you.",
    "Your build process relies on 42 different webpack plugins that you don't understand. The config is a dark art.",
    "You describe your code as 'highly optimized' but it spends 80% of its runtime doing garbage collection.",
    "You listed 'low-level programming' on a resume that is 100% React. This is delusion.",
    "Your test suite is just a shell script that returns exit code 0. You're not testing, you're pretending.",
    "You listed C++ because you printed 'Hello World' in a college lab class three years ago.",
    "Your code is unsafe because you don't understand how data sharing works across thread boundaries.",
    "You describe your stack as 'predictable'—meaning it consistently crashes when the memory usage hits 1.2GB.",
    "Your understanding of pointers is limited to 'the thing that causes segmentation faults'.",
    "You listed WebAssembly because you ran a template compiler once. You have never written a line of WAT.",
    "Your code has memory leaks that you solve by scheduling a daily cron job to restart the node server.",
    "You list 'types' as a skill. Your code uses loose equality for every single comparison check.",
    "Your codebase is a museum of copy-pasted Stack Overflow snippets with no consistent coding style."
  ],
  startup_cto: [
    "I have seen pitch decks from founders with actual revenue. Yours is a pitch deck for your own job application.",
    "The term 'co-founder' appears here without a company name, a product, or a user to validate it.",
    ...
    "Your conviction is high. Your evidence is low. In venture, that gap is called 'pre-seed' for a reason.",
    "We do not fund Figma prototypes. We fund shipped products. Your resume is the former.",
    "The resume includes 'stealth startup'—meaning you are hiding the fact that you have zero users and zero code.",
    "You list your startup as having 'disrupted the market'. The market has not noticed your existence.",
    "Your business plan is buying a domain name and hoping a VC buys it from you for a million dollars.",
    "You describe yourself as a 'serial entrepreneur' on a resume that has zero successful company exits.",
    "Your startup team consists of you, your roommate, and a ChatGPT api key that you share.",
    "You claim to have raised seed capital but the capital was actually a small loan from your parents.",
    "The project has a landing page with a waitlist. The waitlist has three entries. Two of them are you.",
    "You describe your app as 'AI-driven'—meaning you built a standard input box that calls the OpenAI API.",
    "The startup runway is limited by your monthly credit card balance. The burn rate is purely coffee.",
    "You listed your startup on your resume because you couldn't find a job after graduation.",
    ...
    "You list 'VC relations' because you sent a cold email to three partners who immediately archived it.",
    "Your business model is selling subscriptions for a product that hasn't been coded yet.",
    "You claim 'market validation' because your mom said the app idea was 'very nice, honey'.",
    "The product runs on your machine and crashes when you unplug your laptop from the charger.",
    "You list 'equity management' on a company with zero revenue and a valuation of ₹0.",
    "Your pitch deck has 45 slides of financial projections and 0 slides of actual product architecture.",
    "You describe your startup as 'hyper-growth'—meaning you went from 1 user to 2 users in three months."
  ],
  systems_architect: [
    "A distributed system is not a marketing claim. It is a set of engineering tradeoffs you clearly have not made.",
    "CAP theorem is on your resume. The implementation history suggests you cannot explain what the C stands for.",
    ...
    "I have designed systems that serve hundreds of millions of requests. Your system serves your demo video.",
    "Your architecture diagram is a collection of boxes connected by arrows that describes no actual data flow.",
    "You listed 'microservices' because you split your index.js file into three separate files. That is not architecture.",
    ...
    "You listed 'distributed transactions' but your setup relies on local state with zero consensus protocols.",
    ...
    "Your system boundaries are completely arbitrary and make zero sense from a domain-driven design perspective.",
    "The architecture would deadlock the first time a user tries to click a button twice. Race conditions are guaranteed.",
    "You describe a 'resilient system' but the server fails to recover automatically when the database restarts.",
    "Your API is a single endpoint that accepts raw SQL queries from the client. Security is absent.",
    "You list 'event-driven architecture' because you use node event emitters for local state changes.",
    "Your system requires manual intervention to recover from a simple network partition. That is not distributed.",
    "You listed 'load balancing' because you use round-robin DNS to point to two servers.",
    ...
    "Your cache invalidation strategy is restarting the server every hour via cron. That is a temporary patch.",
    "You list 'API gateway' because you use reverse proxy configurations to forward requests to different ports.",
    "Your system has zero auditing, zero logs, and zero monitoring. When it breaks, you will have to guess why.",
    "You listed 'CQRS' because you write read queries in one file and write queries in another. That is not CQRS."
  ]
};
...
const profilesAdd = {
  staff_engineer: [
    ...
    "You learn fast in environments with clear answers and struggle in environments where the answer must be discovered.",
    "You are the kind of developer who rewrites the README before the code is ready.",
    "You are a code-monkey with a senior title who thinks that writing boilerplate code is architectural design.",
    "Your default response to technical feedback is defensive refactoring of the tests to make them pass.",
    "You have constructed a career out of being in the room when actual software was built.",
    "The only thing you deploy is comments explaining why the code doesn't work under load.",
    "You have never had your code reviewed by someone who wasn't trying to avoid an argument with you.",
    "Your engineering philosophy is 'it worked on my machine, so it's a systems issue now'.",
    "You are a repository tourist, leaving stars on others' projects and shipping nothing of your own.",
    "Your code formatting is the only clean part of your entire engineering lifecycle.",
    "You have developed a habit of rewriting standard libraries because you don't trust other people's dependencies.",
    "Your GitHub is a museum of started projects and abandoned repositories. The completion rate is zero.",
    "You have learned how to write resumes that pass ATS checks and fail code compilation screens.",
    "You spend more time configuring your shell than writing code. The tools have become the destination.",
    "Your idea of architecture is creating multiple directories for a simple task. That is organization, not design.",
    "You list technologies you've only used in tutorials. This is a form of technical cosplay.",
    "The code is a collection of hacks held together by comments begging future developers not to touch it.",
    "You are a developer who is very good at explaining why a simple feature will take three weeks.",
    "Your relationship with code is transactional. You write it to get paid, and it shows.",
    "You are the reason why lint checks are mandatory in CI pipelines. You cannot be trusted to format code.",
    "Your technical depth is a thin layer of veneer over a solid block of tutorial boilerplate.",
    "You have avoided learning SQL query planning because you think ORMs are magic solutions."
  ],
  faang_gatekeeper: [
    "The candidate I am reading would struggle to explain their own project choices under questioning.",
    "You have optimized your resume for keyword matching and not for the technical conversation it will initiate.",
    ...
    "I respect that you tried. The interview will reveal what trying without shipping produces.",
    "You are preparing for an interview process you do not yet have the experience to pass.",
    "You are a LeetCode memorizer who thinks that reversing a binary tree is the core of systems development.",
    "Your technical knowledge is a collection of facts compiled for the purpose of passing interviews.",
    "The projects section reads like a list of homework assignments completed under close supervision.",
    "You list 'REST APIs' but you design endpoints that make zero sense under standard conventions.",
    "Your understanding of scaling is entirely theoretical. You have never experienced real traffic load.",
    "You are a copy-paste developer who is very good at pretending to understand the libraries you use.",
    "The resume is designed to impress recruiters who don't know the difference between Java and JavaScript.",
    "Your projects have zero tests because you think testing is a task for QA departments.",
    "You list 'distributed systems' because you ran two services on your laptop at the same time.",
    "The codebase is full of commented-out code blocks from previous tutorials you copied it from.",
    "You have never had a pull request rejected. This is a sign of lack of challenge.",
    "Your API designs are tightly coupled to the UI layout. This will not survive system design.",
    "You listed your fork as an original project. Changing the repository name does not make it yours.",
    "Your github contributions represent code formatters and formatting edits, not engineering output.",
    "You list 'clean code' but your codebase uses loose equality for every single comparison check.",
    "The database schema has zero constraint validation. Data corruption is guaranteed.",
    "You list 'concurrency' but your project runs in a single thread with zero lock contention analysis.",
    "Your cache invalidation strategy is restarting the server every hour via cron. That is a patch.",
    "You listed Helm but you have never customized a chart. You just run helm install and hope.",
    "The deployment takes 15 minutes because you are downloading the entire node_modules directory on every build."
  ],
  devops_veteran: [
    "Real operations engineers have nightmares about the things they have fixed. You sleep soundly because you have fixed nothing.",
    ...
    "Your calmness under operational pressure is untested, which is another way of saying it is unknown.",
    "You talk about infrastructure with the vocabulary of someone who has read the documentation and the confidence of someone who has survived the alerts.",
    "You are a YAML-wrangling script monkey who thinks that writing config files is systems engineering.",
    "Your AWS setup is a security disaster waiting to happen. Port 22 is open to the entire internet.",
    "The CI/CD pipeline is a manual git push origin master. There are no build checks.",
    "You have never written a Terraform state file. Your infrastructure is managed manually via AWS console.",
    "The deployment logs are full of build errors that you bypassed by turning off the linter checks.",
    "Your secret management strategy is committing the .env file directly to your public repository.",
    "You cannot explain the difference between a health check and a readiness probe under questioning.",
    "Your database backups are stored in the same directory as the database file on the same disk.",
    "The monitoring setup consists of you refreshing the page periodically to check if the site is up.",
    "You list 'load balancing' because you use round-robin DNS to point to two different servers.",
    "The production cluster is actually a single node running on a free tier instance with zero redundancy.",
    "Your on-call runbook is a text document that says 'restart the server and pray'. That is not SRE.",
    "You describe 'highly secure infrastructure' but your database has no password and is exposed publicly.",
    "You listed Helm but you have never customized a chart. You just run helm install and hope.",
    "The deployment takes 15 minutes because you are downloading the entire node_modules directory on every build.",
    "Your logs are console.log statements scattered across the codebase with no centralized telemetry.",
    "You listed Nginx because you copy-pasted a reverse proxy config from a Medium article.",
    "The resume describes 'automated scaling'—meaning you manually spin up another server when the site gets slow.",
    "You claim Docker expertise but your images are 1.2 GB because you don't know multi-stage builds.",
    "The pipeline doesn't have error handling. If a build fails, the deploy script just leaves the site broken."
  ],
  oss_maintainer: [
    "Your relationship with code review is one of author, never reviewer. This is a knowledge gap.",
    "You have never had to maintain backward compatibility for someone else's integration. That is the test of real API design.",
    ...
    "A green contribution graph is not a portfolio. A portfolio requires work that other engineers have evaluated.",
    "You have written code for yourself and called it open-source contribution.",
    "You are a code tourist who thinks that fixing typo READMEs is open source contribution.",
    "Your repository has 42 stars because you asked all your classmates to star it on the first day.",
    "You list 'collaborative development' but the git commit history has only one author: you.",
    "The code quality checker returned 18 warnings that you ignored by adding eslint-disable comments.",
    "Your issue tracker is empty because nobody else is using the software you spent three months writing.",
    "You describe your project as an 'ecosystem'—meaning it has a frontend, a backend, and a README.",
    "The commit history shows you haven't touched this project since the day you put it on your resume.",
    "You claim to write maintainable code but the codebase is a single 4000-line index.js file.",
    "Your dependency list includes 45 helper libraries for problems that could be solved in three lines of vanilla JS.",
    "The documentation has a 'getting started' section that fails at step 2 due to outdated versions.",
    "You listed your portfolio as an open-source project. It's just a static HTML file.",
    "Your pull requests contain messages like 'fixed stuff' and 'clean code'. No description of changes.",
    "You have never had a pull request rejected. That means you have never submitted code to a real project.",
    "The codebase is full of commented-out code blocks from previous tutorials you copied it from.",
    "You list 'API designer' but your endpoints are inconsistent and have zero validation.",
    "Your code formatting is completely inconsistent because you don't use Prettier or ESLint rules.",
    "The build is broken on master. This tells me everything about your development workflow.",
    "You listed your fork as an original project. Changing the name in the package.json does not make it yours.",
    "Your test suite consists of a single test that prints 'all tests passed' automatically.",
    "The commit graph has a huge gap between semesters. You only code when you're being graded."
  ],
  exhausted_recruiter: [
    "Your professional narrative is borrowed from LinkedIn influencers and applied to a background that does not support it.",
    ...
    "What I want to see is one concrete thing you built, measured, and improved. It is not here.",
    "I have seen this exact resume, formatted differently, one hundred and eighty times this quarter.",
    "You are a buzzword-spammer whose resume is a collection of adjectives and no outcomes.",
    "You list 'experience with agile methodologies'—meaning you sat in standup meetings and said 'no blockers'.",
    "Your skills list is so long it takes up half the page. You don't know half of these tools.",
    "The only number on your resume is your phone number. Hiring managers want metrics, not text.",
    ...
    "Your resume is two pages long but contains only one page of actual content. Spacing does the work.",
    "You listed your college group project as professional work. We can tell from the repository name.",
    "The summary section contains seven adjectives in the first sentence. None are backed by evidence.",
    "You claim to have 'led development' on a project where you were the only developer. That is not leadership.",
    "The job titles on your resume are inconsistent with your actual experience level.",
    "Your contact info is missing a link to your portfolio. If we can't see the code, we assume it's bad.",
    "You listed 'quick learner' because you don't have enough projects to prove you know the tools.",
    "The company descriptions are longer than your achievements at those companies.",
    "You listed a certification that expired in 2024. This shows lack of attention to detail.",
    "The resume includes 'proficient in office suites'. This is not a technical skill.",
    "Your project section lists a weather app that uses a hardcoded API key and has been broken for months.",
    "You describe yourself as 'passionate' but your github graph has been grey since the boot camp ended.",
    "The experience section starts with your education. This tells us your career hasn't started yet.",
    "Your bullet points describe what the team did, not what you did. You take credit for others' work."
  ],
  rust_elitist: [
    "Your instinct, when facing a bug, is to search Stack Overflow for the error message rather than reason about the cause.",
    "You have never been forced by a compiler to understand why your code is wrong. That is a privilege with a cost.",
    ...
    "Your build process relies on 42 different webpack plugins that you don't understand.",
    "You describe your code as 'highly optimized' to run on single-thread node.",
    "You listed C++ because you printed 'Hello World' in a college lab class three years ago.",
    "Your code is unsafe because you don't understand how data sharing works across thread boundaries.",
    "You describe your stack as 'predictable'—meaning it consistently crashes when memory hits 1.2GB.",
    "Your understanding of pointers is limited to 'the thing that causes segmentation faults'.",
    "You listed WebAssembly because you ran a template compiler. You have never written a line of WAT.",
    "Your code has memory leaks that you solve by scheduling a daily cron job to restart the server.",
    "You list 'types' as a skill. Your code uses loose equality for every comparison check.",
    "Your codebase is a museum of copy-pasted Stack Overflow snippets with no style consistency.",
    "You listed JavaScript as a systems language. This is a category error of proportions.",
    "Your understanding of garbage collection is 'it deletes variables when I'm done'.",
    "You claim to write safe code but you use 'as any' in TypeScript to bypass compiler checks.",
    "Your dependency tree contains left-pad. The security audit is a tragedy of warnings.",
    "You listed Rust because you read a blog post. Your actual repository has three commits of template.",
    "You listed 'low-level programming' on a resume that is 100% React. This is delusion."
  ],
  startup_cto: [
    "The vocabulary of venture capital has colonized your resume in the absence of venture results.",
    ...
    "Your startup team consists of you, your roommate, and a shared ChatGPT api key.",
    "You claim to have raised seed capital but the capital was actually a small loan from parents.",
    "The project has a landing page with a waitlist. The waitlist has three entries. Two of them are you.",
    "The startup runway is limited by your monthly credit card balance. Burn rate is purely coffee.",
    "You listed your startup on your resume because you couldn't find a job after graduation.",
    "Your co-founder is your dog. The dog is the only team member who doesn't argue with tech choices.",
    "You describe your prototype as 'production-ready'. The database runs on a local SQLite file in '/tmp'.",
    "Your startup was 'acquired'—meaning you deleted the repository and updated your LinkedIn profile.",
    "You list 'VC relations' because you sent a cold email to three partners who immediately archived it.",
    "Your business model is selling subscriptions for a product that hasn't been coded yet.",
  ...
  systems_architect: [
    ...
    "Your technical vocabulary is current. Your operational intuition is not yet developed.",
    "You design systems on whiteboards and not in production, and the difference is everything.",
    "You are a database partitioner whose partition strategy is the sentence 'we use a distributed database'.",
    "Your schema has circular dependencies that will deadlock the database on the first concurrent transaction.",
    "You claim to write scalable APIs but you run all database queries inside synchronous loops.",
    "Your architectural design is copy-pasted from a Netflix tech blog post with no understanding of the trade-offs.",
    "You listed 'distributed transactions' but your setup relies on local state with zero consensus protocols.",
...
const verdictsAdd = {
  staff_engineer: [
    ...
    "Not ready. Not never — just not now. Ship something first. Then send this again.",
    "File this resume under 'developing' and come back when there is shipped evidence to support the claims.",
    "REJECTED. You are a code-monkey with a senior title. Build something load-bearing before resubmitting.",
    "No hire. Your code architecture has the stability of wet cardboard. Go back to basics.",
    "Declined. We do not hire tutorial merchants who have never shipped a single original line of code.",
    "Passed on. The gap between your claims and your git history is wide enough to host a data center.",
    "Not this round. Spend six months debugging actual production code before trying again.",
    "Rejected. Your resume reads like AI autocomplete gained consciousness and immediately started lying.",
    "No. Your testing coverage is zero and your confidence is a hundred. That is a security hazard.",
    "Archived in the trash bin. You are the reason why we need automated compile checks.",
    "Strong decline. You write spaghetti code and call it microservices design. It is not.",
    "No offer. Your primary engineering skill is creating circular dependencies that deadlock databases.",
    "Passed. Return when you have operated what you designed and survived the post-mortem.",
    "Rejected. You list Rust because it is trendy but your code is unoptimized Node.js chaos.",
    "No. The commitment is there, but the execution history is functionally non-existent.",
    "Declined. Your commits are all 'fix' and 'update'. Collaborative git history is absent.",
    "Not ready. You list 12 frameworks but cannot explain how a compiler works under the hood.",
    "Pass. Your project section is a museum of started and abandoned repositories. Completion rate is zero.",
    "Rejected. You write code like a junior developer who just discovered Stack Overflow.",
    "No hire. You describe changing button padding as 'revolutionizing user experiences'. No.",
    "Passed on. Your database schema has zero indexes and every query triggers a full table scan.",
    "Declined. The resume is more polished than the repositories it links to. This is a ratio problem.",
    "No. You spend more time configuring your shell than writing code. The tools are not the destination.",
    "Rejected. You list TypeScript but cast everything as 'any'. We see your shortcuts.",
    "No offer. Your code organization has the structural integrity of wet cardboard.",
    "Declined. You listed Docker because you ran 'docker-compose up' once. This is not DevOps.",
    "Pass. The system diagram described is a copy of a blog post. It doesn't reflect your code.",
    "REJECTED. Your resume is load-bearing buzzwords on a foundation of tutorial sandboxes."
  ],
  faang_gatekeeper: [
    "Archived. The keyword filter was impressed. Nothing downstream was.",
    "No offer. Strong recommendation to spend six months building something at scale before the next application.",
    ...
    "Not this cycle. Not this level. Two levels down and a year of real shipping and we talk again.",
    "The system design round will be educational for everyone involved, including and especially you.",
    "REJECTED. You are an absolute LeetCode memorizer who cannot design a simple rate limiter.",
    "No hire. The resume keyword filter was fooled, but the human review layer was not.",
    "Declined. Spend less time on sandbox exercises and more time shipping to actual production.",
    "Passed on. Your system design round would be a tragedy of race conditions and lock contention.",
    "Not this round. Your understanding of scaling is entirely theoretical. No scaling scars present.",
    "Rejected. You list 15 tools but your repos contain zero code tests. You are not ready.",
    "No. You claim backend expertise but cannot explain the N+1 query problem in your own words.",
    "Archived. You are a copy-paste developer who is very good at pretending to understand libraries.",
    "Strong decline. You list Kubernetes but your longest deployment was a Vercel preview page.",
    "No offer. Your project section contains zero examples of handling failure or edge cases.",
    "Passed. Return when you have a production incident story. Any story at all.",
    "Rejected. Your database knowledge is limited to basic CRUD. No indexing or query planning.",
    "No. You claim 'clean code' but your codebase uses loose equality for every comparison check.",
    "Declined. The resume is technically correct but substantively empty. Spacing does the work.",
    "Not ready. You list 'distributed databases' but don't know SQL and NoSQL trade-offs.",
    "Pass. Your projects are all single-file scripts disguised as modular systems.",
    "Rejected. Your contribution graph represents code formatters and formatting edits, not engineering.",
    "No hire. You listed Web3 because you watched a smart contract crash course. Zero deployed contracts.",
    "Passed on. The interview will ask you to optimize a query. Your resume suggests NoSQL rewrite.",
    "Declined. You claim React expertise but cannot explain the reconciliation algorithm.",
    "No. Your projects have zero tests because you think testing is a task for QA departments.",
    "Rejected. You listed your fork as an original project. Changing package.json name does not make it yours.",
    "No offer. The codebase is full of commented-out code blocks from previous tutorials.",
    "Declined. Your API designs are tightly coupled to the UI layout. This will fail.",
    "Pass. You listed 'expert' for technologies you've only used in school or tutorial projects.",
    "REJECTED. You have optimized your resume for keyword matching and not for technical depth."
  ],
  devops_veteran: [
    "Do not deploy this person to any environment where real users depend on availability.",
    "The on-call rotation will not be kind to someone with this level of operational preparation.",
    ...
    "PIPELINE EXITED WITH CODE 1. The engineer described here is not production-ready.",
    "This resume is a threat assessment. Threat level: high to the uptime of any system you are allowed near.",
    "REJECTED. You are a YAML-wrangling script monkey who has never had to roll back a deploy.",
    "No hire. Your AWS setup has port 22 open to the entire internet. This is a security hazard.",
    "Declined. Your CI/CD pipeline is a manual git push origin master. This is not automation.",
    "Passed on. You claim infrastructure-as-code but have never written a Terraform state file.",
    "Not this round. The deployment logs are full of build errors that you bypassed manually.",
    "Rejected. Your secret management strategy is committing the .env file directly to GitHub.",
    "No. You cannot explain the difference between a health check and a readiness probe.",
    "Archived in the rejection queue. Your database backups are stored on the same disk as the db.",
    "Strong decline. The monitoring setup consists of you refreshing the page. That is not SRE.",
    "No offer. Your production cluster is actually a single node running on a free tier instance.",
    "Passed. Return when your on-call runbook says something other than 'restart the server'.",
    "Rejected. You listed Nginx because you copy-pasted a reverse proxy config from Medium.",
    "No. The resume describes 'automated scaling'—meaning you manually spin up another server.",
    "Declined. You claim Docker expertise but your images are 1.2 GB because you don't know multi-stage.",
    "Not ready. The pipeline doesn't have error handling. If a build fails, the site stays broken.",
    "Pass. You list Helm but have never customized a chart. You run helm install and hope.",
    "Rejected. The deployment takes 15 minutes because you download node_modules on every build.",
    "No hire. Your logs are console.log statements with no centralized telemetry or metrics.",
    "Passed on. You list Kubernetes but your longest deployment was a Vercel preview page.",
    "Declined. Docker without a pipeline means you are containerizing local development, not DevOps.",
    "No. Database backups, disaster recovery, and failover strategies are completely absent.",
    "Rejected. PagerDuty has never woken you up at 3am. This resume makes that obvious.",
    "No offer. Your 'cloud experience' is a serverless function on a free tier with zero load.",
    "Declined. CI/CD without specifying the tooling or the artifacts produced is not CI/CD.",
    "Pass. You have listed infrastructure tools the way a tourist lists cities they have flown over.",
    "REJECTED. An SRE who has never written a runbook is a developer with a job title upgrade."
  ],
  oss_maintainer: [
    "Marked as duplicate. We have received this developer profile before with different names.",
    "WON'T MERGE. The evidence for the described experience level is not sufficient.",
    ...
    "GIT BLOCK INITIATED. Resume quality insufficient to justify proceeding to next review stage.",
    "THREAD LOCKED. This contribution history does not meet the standard for meaningful authorship.",
    "REJECTED. You are a copy-paste code tourist whose only contribution is fixing README typos.",
    "No hire. The repository has stars because you asked all your classmates to star it.",
    "Declined. The git commit history has only one author: you. Collaborative coding absent.",
    "Passed on. The checker returned 18 warnings that you ignored by adding eslint-disable.",
    "Not this round. Your issue tracker is empty because nobody is using the software you wrote.",
    "Rejected. You describe your project as an 'ecosystem'—meaning frontend, backend, and README.",
    "No. The commit history shows you haven't touched this project since putting it on your resume.",
    "Archived. The codebase is a single 4000-line index.js file. Not maintainable.",
    "Strong decline. Your dependency list includes 45 helper libraries for basic problems.",
    "No offer. The documentation has a 'getting started' section that fails at step 2.",
    "Passed. You listed your portfolio as an open-source project. It's just a static HTML file.",
    "Rejected. Your pull requests contain messages like 'fixed stuff' with zero description.",
    "No. You have never had a pull request rejected. You have never submitted code to a real project.",
    "Declined. The codebase is full of commented-out code blocks from previous tutorials.",
    "Not ready. You list 'API designer' but your endpoints have zero schema validation.",
    "Pass. Your code formatting is completely inconsistent because you don't use Prettier.",
    "Rejected. The build is broken on master. This tells me everything about your workflow.",
    "No hire. You listed your fork as an original project. Changing package.json name is not engineering.",
    "Passed on. Your test suite consists of a single test that prints 'all tests passed' automatically.",
    "Declined. The commit graph has a huge gap. You only code when you're being graded.",
    "No. Your relationship with code review is one of author, never reviewer. Knowledge gap.",
    "Rejected. You write code in isolation. Production codebases are collaborative artifacts.",
    "No offer. Your API surface area has never been consumed by a developer who did not write it.",
    "Declined. The project has a license file. That's the only file edited in eight months.",
    "Pass. A repository with star count zero has never been evaluated by anyone else.",
    "REJECTED. Forking a repository and running it is listed as experience. It is not."
  ],
  exhausted_recruiter: [
    "Thank you for your application. We will not be moving forward. Please also update the project section before your next submission.",
    "Your profile has been reviewed. The outcome is consistent with what the experience section predicts.",
    ...
    "After review, we have decided to continue with other candidates. Those candidates had outcomes listed in their experience section.",
    "Archived in the rejection queue. Nothing personal — it is a volume problem that you did not solve.",
    "REJECTED. You are a buzzword-spammer whose resume is a collection of adjectives and no metrics.",
    "No hire. You list 'agile methodologies' because you sat in standups and said 'no blockers'.",
    "Declined. Your skills list is half the page. We know you don't know half of these tools.",
    "Passed on. The only number on your resume is your phone number. Metrics are absent.",
    "Not this round. You describe yourself as a 'thought leader' with one year of junior experience.",
    "Rejected. The internship bullet points are written in the passive voice. Assisted means ordered lunch.",
    "No. Your resume is two pages long but contains only one page of actual content.",
    "Archived. You listed your college group project as professional work. We checked the repo.",
    "Strong decline. The summary contains seven adjectives and zero outcomes. Fluff.",
    "No offer. You claim to have 'led development' on a project where you were the only developer.",
    "Passed. The job titles on your resume are inconsistent with your actual experience level.",
    "Rejected. Your contact info is missing a link to your portfolio. We assume the code is bad.",
    "No. You listed 'quick learner' because you don't have enough projects to prove you know the tools.",
    "Declined. The company descriptions are longer than your achievements at those companies.",
    "Not ready. You listed a certification that expired in 2024. Lack of attention to detail.",
    "Pass. The resume includes 'proficient in office suites'. This is not a technical skill.",
    "Rejected. Your project section lists a weather app that uses a hardcoded API key and is broken.",
    "No hire. You describe yourself as 'passionate' but your github graph has been grey for months.",
    "Passed on. The experience section starts with education. Your career hasn't started yet.",
    "Declined. Your bullet points describe what the team did, not what you did. Taking credit.",
    "No. Three companies in eighteen months is a pattern that hiring managers notice.",
    "Rejected. Passive verbs — 'assisted', 'helped', 'supported' — tell a reader nothing.",
    "No offer. You have applied for a senior role. Your most recent job title was junior. Decline.",
    "Declined. References available upon request has not communicated anything useful since 2008.",
    "Pass. The cover letter would be more credible if the experience section supported it.",
    "REJECTED. You have described your professional history with the specificity of a horoscope."
  ],
  rust_elitist: [
    "COMPILE ERROR FATAL: CLAIM VERIFICATION FAILED AT EVERY CONSTRAINT BOUNDARY.",
    "You are not systems programming. You are application programming with delusions of depth.",
    ...
    "Your mental model has memory leaks. Every abstraction you rely on is hiding a concept you have not learned.",
    "Your code is unsafe in ways you are not aware of because your runtime hides the evidence.",
    "REJECTED. You are a safe-runtime dependent developer who thinks memory management is magic.",
    "No hire. Your database schema has zero transactions and zero validation. Integrity is absent.",
    "Declined. You claim to optimize for memory but load 14MB of javascript on initial render.",
    "Passed on. You have never written a lock, a mutex, or a semaphore. Concurrency is absent.",
    "Not this round. Your build process relies on 42 different webpack plugins you don't understand.",
    "Rejected. You describe your code as 'highly optimized' but it spends 80% of runtime in GC.",
    "No. You listed C++ because you printed 'Hello World' in a college lab class once.",
    "Archived. Your code is unsafe because you don't understand data sharing across threads.",
    "Strong decline. Your stack is 'predictable'—meaning it consistently crashes when memory hits 1.2GB.",
    "No offer. Your understanding of pointers is limited to 'the thing that causes segfaults'.",
    "Passed. You listed WebAssembly because you ran a template compiler. You have written 0 WAT.",
    "Rejected. Your code has memory leaks that you solve by scheduling a daily cron server restart.",
    "No. You list 'types' as a skill. Your code uses loose equality for comparison checks.",
    "Declined. Your codebase is a museum of copy-pasted Stack Overflow snippets with no style.",
    "Not ready. You listed JavaScript as a systems language. This is a category error.",
    "Pass. Your understanding of GC is 'it deletes variables when I am done'. Crutch.",
    "Rejected. You claim to write safe code but use 'as any' in TypeScript to bypass compiler.",
    "No hire. Your dependency tree contains left-pad. Security audit is a tragedy.",
    "Passed on. You listed Rust because you read a blog post. Repo has three commits of template.",
    "Declined. You listed 'low-level programming' on a resume that is 100% React. Delusion.",
    "No. Your entire project history runs in environments where GC hides your memory mistakes.",
    ...
    "Declined. The safety of your runtime is inversely proportional to your depth of understanding.",
    "Pass. You listed 'systems programmer' on a resume containing exclusively JS. Category error.",
    "REJECTED. You have selected comfort over competence at every fork in your learning path."
  ],
  startup_cto: [
    "VC RUNWAY EXHAUSTED. The pitch was not compelling. The product does not exist.",
    "Pass at this stage. Come back with users, revenue, or one real shipped thing.",
    ...
    "No. Ship something. Then ship something again. Then call us.",
    "No term sheet. Insufficient evidence of shipping to justify further conversation.",
    "REJECTED. You are an AI wrapper merchant whose product is a standard OpenAI API input.",
    "No hire. Your startup team consists of you and a shared ChatGPT API key. Pre-revenue.",
    "Declined. You claim to have raised seed capital but it was actually a small loan from parents.",
    "Passed on. The project landing page waitlist has three entries. Two of them are you.",
    "Not this round. The startup runway is limited by your credit card balance. Burn is coffee.",
    "Rejected. You listed your startup on your resume because you couldn't find a job.",
    "No. Your co-founder is your dog. The dog is the only team member who doesn't argue.",
    "Archived. Your prototype runs on a local SQLite file in '/tmp'. Not production ready.",
    "Strong decline. Your startup was 'acquired'—meaning you deleted the repo and updated LinkedIn.",
    "No offer. You list 'VC relations' because you sent a cold email to three partners who archived it.",
    "Passed. Your business model is selling subscriptions for a product that hasn't been coded.",
    "Rejected. You claim 'market validation' because your mom said the idea was nice.",
    "No. The product runs on your machine and crashes when you unplug your laptop charger.",
    "Declined. You list 'equity management' on a company with zero revenue and a valuation of ₹0.",
    "Not ready. Your pitch deck has 45 slides of projections and 0 slides of actual architecture.",
    "Pass. You describe your startup as 'hyper-growth'—meaning you went from 1 user to 2 users.",
    "Rejected. The resume includes 'stealth startup'—meaning you are hiding the fact of zero code.",
    "No hire. You list your startup as having 'disrupted the market'. The market has not noticed.",
    "Passed on. Your business plan is buying a domain name and hoping a VC buys it from you.",
    "Declined. You describe yourself as a 'serial entrepreneur' with zero successful exits.",
    "No. You call yourself a CEO because you spent a weekend editing a Figma file. Runway is zero.",
    "Rejected. The startup chapter needs to end with a shipped product, not coffee shop meetings.",
    "No offer. You talk about scaling to millions. Your setup has never met three simultaneous users.",
    "Declined. Your product-market fit analysis is missing a product and a market.",
    "Pass. MVP does not mean Minimum Viable Presentation. You have the first. Not the second.",
  ...
  systems_architect: [
    ...
    "The architecture would work on a whiteboard. The whiteboard is not production. This role requires production.",
    "DEADLOCK DETECTED. This architecture has circular dependencies that will be discovered in production.",
    "REJECTED. You are a database partitioner whose partition strategy is the sentence 'we use a distributed db'.",
    "No hire. Your database schema has circular dependencies that will deadlock on concurrent transactions.",
    "Declined. You claim to write scalable APIs but you run all SQL queries inside synchronous loops.",
    "Passed on. Your architectural design is copy-pasted from a blog post with no trade-off analysis.",
    "Not this round. You listed 'distributed transactions' but your setup relies on local state.",
    "Rejected. Your database is a single PostgreSQL instance with no replication, running on free tier.",
    "No. You claim to optimize for latency but you have never configured a CDN or used cache.",
    "Archived. Your system boundaries are arbitrary and make zero sense from domain-driven design.",
    "Strong decline. The architecture deadlocks when a user clicks twice. Race conditions guaranteed.",
    "No offer. You describe a 'resilient system' but the server fails to recover when db restarts.",
    "Passed. Your API is a single endpoint that accepts raw SQL queries. Security is absent.",
    "Rejected. You list 'event-driven architecture' because you use node event emitters for local state.",
    "No. Your system requires manual intervention to recover from a simple network partition.",
    "Declined. You listed 'load balancing' because you use round-robin DNS to point to two servers.",
    "Not ready. The database schema has zero constraint validation. Data corruption is guaranteed.",
    "Pass. You describe 'highly scalable architecture' but your server runs on a single thread.",
    "Rejected. Your cache invalidation strategy is restarting the server every hour via cron.",
    "No hire. You list 'API gateway' because you use reverse proxy config to forward requests.",
    ...
    "No. You have designed microservices without service discovery or eventual consistency. Monolith.",
    "Rejected. You have designed a system with a single point of failure and claim it is fault-tolerant.",
    "No offer. The latency requirements are described without tail latency. P99 is what matters.",
    "Declined. Your architecture has never been reviewed by another engineer. It is visible in docs.",
    "Pass. CAP theorem is on your resume. You cannot explain what the C stands for in first principles.",
